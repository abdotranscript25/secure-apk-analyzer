...
[![JADX](https://img.shields.io/badge/JADX-1.5.5-red.svg)](https://github.com/skylot/jadx)
...
3. [Ordre d'exécution](#-ordre-dexécution)
4. [Composants détaillés](#-composants-détaillés)
5. [Installation](#-installation)
6. [Utilisation](#-utilisation)
7. [Résultats](#-résultats)
8. [Comparaison avec MobSF](#-comparaison-avec-mobsf)
9. [Limites](#-limites)
10. [Auteurs](#-auteurs)
...
### 2. `AIBehaviorAnalyzer.java` — IA comportementale
...
### 3. `RiskPredictor.java` — Prédiction de risque
...
### 4. `UltimateReport.java` — Structure du rapport
...
Ce projet combine **analyse statique traditionnelle** (règles regex, décompilation JADX) et une couche d'**IA comportementale** pour la corrélation de patterns malveillants, le tout exposé via une interface web Spring Boot. L'outil dépasse MobSF sur certaines détections tout en étant 3x plus rapide sur l'APK de test.
